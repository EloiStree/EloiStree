...
# [To check: Meta Connect conferences](https://api.github.com/repos/EloiStree/HelloQuest3/issues/1)  
...
# [To watch: At the release, all youtubers were ready to post Second-1. So let's watch all that.](https://api.github.com/repos/EloiStree/HelloQuest3/issues/2)  
...
# [To Craft: 3D print strapper for hands back holder.](https://api.github.com/repos/EloiStree/HelloQuest3/issues/3)  
...
# [To Craft: Sun filter to put in front of cameras](https://api.github.com/repos/EloiStree/HelloQuest3/issues/4)  
  
   
  
-----------------------------------------  
  
# [To Craft: Paper label zone to print on the Quest and 3D holder like for the Quest 2](https://api.github.com/repos/EloiStree/HelloQuest3/issues/5)  
  
   
  
-----------------------------------------  
  
# [To experiment: Take a stereo camera and try to display it as a 2D fly photo and 2D "override" ](https://api.github.com/repos/EloiStree/HelloQuest3/issues/6)  
  
   
  
-----------------------------------------  
  
# [Topic: Where to fetch 3D mesh of the Quest 3 ?](https://api.github.com/repos/EloiStree/HelloQuest3/issues/7)  
...
# [To overwatch: Does the 3D assets in the Quest 3 are easy to code or just 3D as WMR ?](https://api.github.com/repos/EloiStree/HelloQuest3/issues/8)  
  
   
  
-----------------------------------------  
  
# [Topic: Copy past of the influencer at H-5](https://api.github.com/repos/EloiStree/HelloQuest3/issues/9)  
...
# [In workshop: be able to use ChatGPT with the voice of the Quest](https://api.github.com/repos/EloiStree/HelloQuest3/issues/10)  
  
   
  
-----------------------------------------  
  
# [Topic: What is the resolution of the Quest 3](https://api.github.com/repos/EloiStree/HelloQuest3/issues/11)  
...
# [Topic: Publish on App Lab of Oculus Quest ](https://api.github.com/repos/EloiStree/HelloQuest3/issues/12)  
  
   
  
-----------------------------------------  
  
# [Topic: How to use body tracking of the Quest 3 in the Oculus SDK](https://api.github.com/repos/EloiStree/HelloQuest3/issues/13)  
...
# [Topic: Game at D1 on the Quest 3 ?](https://api.github.com/repos/EloiStree/HelloQuest3/issues/14)  
...
# [Topic: Review D-1 of Youtubers](https://api.github.com/repos/EloiStree/HelloQuest3/issues/15)  
...
# [Topic: Vibration of the Quest 3 is apparently more customable ?](https://api.github.com/repos/EloiStree/HelloQuest3/issues/16)  
...
# [Topic: What setting to put to crop sidequest with Quest 3](https://api.github.com/repos/EloiStree/HelloQuest3/issues/17)  
...
# [Topic: Create a protection for the lens as the one given in the Quest 3 box.](https://api.github.com/repos/EloiStree/HelloQuest3/issues/18)  
...
# [Topic: Where to find adaptor for BoboVR M2 on Quest 3](https://api.github.com/repos/EloiStree/HelloQuest3/issues/19)  
...
# [Topic: What look like the infrared inside the Quest 3 controller ?](https://api.github.com/repos/EloiStree/HelloQuest3/issues/20)  
...
# [Topic, Question: Microphone of Quest 3 is bad. Can we do something about it ?](https://api.github.com/repos/EloiStree/HelloQuest3/issues/21)  
  
 If you want a good mic quality. Can we work on it with USB C cable or jack having microphone in it ?  
  
-----------------------------------------  
  
# [Topic, Cool: Mixed reality VR chat party :)](https://api.github.com/repos/EloiStree/HelloQuest3/issues/22)  
...
# [Topic,Video: Use MRTK on Quest 2 (& 3)](https://api.github.com/repos/EloiStree/HelloQuest3/issues/23)  
...
# [Topic, Must-Know:  How to create a portal in wall, ground and ceiling](https://api.github.com/repos/EloiStree/HelloQuest3/issues/24)  
...
# [Topic, Must-Know: How to use the room scan (mesh) of Oculus 3](https://api.github.com/repos/EloiStree/HelloQuest3/issues/25)  
  
   
  
-----------------------------------------  
  
# [Topic, Must-Know: How to use the Oculus API to have the room (Ground Wall, Door...)](https://api.github.com/repos/EloiStree/HelloQuest3/issues/26)  
  
   
  
-----------------------------------------  
  
# [Topic, Must-Know: Create your own room scan DIY in Unity 3D instead of the Oculus one.](https://api.github.com/repos/EloiStree/HelloQuest3/issues/27)  
...
# [Add: What is Oculus Dashboard and how to use it ?](https://api.github.com/repos/EloiStree/HelloQuest3/issues/28)  
...
# [Add: What is OVR Metric and how to use it ? How to install it ?](https://api.github.com/repos/EloiStree/HelloQuest3/issues/29)  
...
# [Add, Have a look: Git Code of the game First Hand.](https://api.github.com/repos/EloiStree/HelloQuest3/issues/30)  
...
# [Add, Complex: How to use Voice in Quest 3 (see photon)](https://api.github.com/repos/EloiStree/HelloQuest3/issues/31)  
...
# [Topic: What are Shared Spatial Anchors  of Oculus?](https://api.github.com/repos/EloiStree/HelloQuest3/issues/32)  
...
# [Add, Explore: World Beyond in Unity ? (Maybe Important)](https://api.github.com/repos/EloiStree/HelloQuest3/issues/33)  
...
# [Add, Explore: Unity Depth API sample](https://api.github.com/repos/EloiStree/HelloQuest3/issues/34)  
...
# [Add, Explore: How to use the meshes (Phanto)](https://api.github.com/repos/EloiStree/HelloQuest3/issues/35)  
...
# [Add: Project Whisperer to show how to use Voice in Oculus](https://api.github.com/repos/EloiStree/HelloQuest3/issues/36)  
...
# [Add: How to use https://wit.ai with Quest 3 ?](https://api.github.com/repos/EloiStree/HelloQuest3/issues/37)  
...
# [Question: How much electricity use a Quest 3 when screen is black in Unity3D.](https://api.github.com/repos/EloiStree/HelloQuest3/issues/38)  
  
 The aim is to do a docker that can be use when not doing VR.  
  
-----------------------------------------  
  
# [Good to know, To Video: There are several sample demo and downloadable on Meta Quest Developer App.](https://api.github.com/repos/EloiStree/HelloQuest3/issues/39)  
...
# [Topic: Meta Connect video in link with MR and Unity3D](https://api.github.com/repos/EloiStree/HelloQuest3/issues/40)  
...
# [Stupid Mistake: I did not have the Link passthrough because I was connected to the wrong account in Oculus Setup.](https://api.github.com/repos/EloiStree/HelloQuest3/issues/41)  
...
# [Unity Feature: NavMeshSurface for AI to move on the mesh of the room.](https://api.github.com/repos/EloiStree/HelloQuest3/issues/44)  
...
# [Topic: Detect collision with the mesh wireframe ](https://api.github.com/repos/EloiStree/HelloQuest3/issues/45)  
...
# [Topic, Must-Know: How to have access to the volume and ID of the elements in a Meta Room ?](https://api.github.com/repos/EloiStree/HelloQuest3/issues/46)  
  
   
  
-----------------------------------------  
  
# [Manual: Lynx R1 Wiki](https://api.github.com/repos/EloiStree/HelloQuest3/issues/47)  
...
# [Question: Can we use the Quest 3 outside ?](https://api.github.com/repos/EloiStree/HelloQuest3/issues/48)  
...
# [Question: Can we play Oculus Quest 3 in the train ?](https://api.github.com/repos/EloiStree/HelloQuest3/issues/49)  
...
# [Question: What happens if you use sidequest Q3 video as stereo image in Unity ?](https://api.github.com/repos/EloiStree/HelloQuest3/issues/50)  
...
# [To know: How to use Quest Link (Cable and Air)](https://api.github.com/repos/EloiStree/HelloQuest3/issues/51)  
...
# [Topic: Floor is lava (Guide)](https://api.github.com/repos/EloiStree/HelloQuest3/issues/52)  
...
# [Question, Twitch: Can we remove the frame of the Quest 3 for better IPD ?](https://api.github.com/repos/EloiStree/HelloQuest3/issues/53)  
...
# [Question: How to export the room to play in it without the headset running ?](https://api.github.com/repos/EloiStree/HelloQuest3/issues/54)  
...
# [Topic: what is inside the Quest 3 (Tear down)](https://api.github.com/repos/EloiStree/HelloQuest3/issues/55)  
  
 https://youtu.be/liVll-GVF3Q  
  
-----------------------------------------  
  
# [Topic, Tip&Trick: Shortcut to start recording in Quest 3](https://api.github.com/repos/EloiStree/HelloQuest3/issues/56)  
...
# [Topic: How to play on Quest 3 when you have glass ?](https://api.github.com/repos/EloiStree/HelloQuest3/issues/57)  
...
# [Question: Can we play large zone with Quest 3 (No)](https://api.github.com/repos/EloiStree/HelloQuest3/issues/58)  
...
# [Question: Can we use USB key or Disk on the Quest 3 ?](https://api.github.com/repos/EloiStree/HelloQuest3/issues/59)  
...
# [Question: Can we use webcam on the Quest 3 (was impossible on Quest 2)](https://api.github.com/repos/EloiStree/HelloQuest3/issues/60)  
  
   
  
-----------------------------------------  
  
# [Question: Can we use hand tracking in 3DOF mode ?](https://api.github.com/repos/EloiStree/HelloQuest3/issues/61)  
  
 Does not seem to work because Quest is disabling the passthrough when in 3DOF.  
  
-----------------------------------------  
  
# [Experiment to code: Do an application that export the room mesh and the room scale as STL (just that)](https://api.github.com/repos/EloiStree/HelloQuest3/issues/62)  
...
# [Experiment: Compare the Hololens Fragment game with Oculus Quest 3](https://api.github.com/repos/EloiStree/HelloQuest3/issues/63)  
...
# [To Do: create stl to turn off batteries in the Quest when in bag.](https://api.github.com/repos/EloiStree/HelloQuest3/issues/64)  
  
   
  
-----------------------------------------  
  
# [To Do: create stl to turn off batteries in the Quest when in bag.](https://api.github.com/repos/EloiStree/HelloQuest3/issues/65)  
  
   
  
-----------------------------------------  
  
# [To Do: create stl to turn off batteries in the Quest when in bag.](https://api.github.com/repos/EloiStree/HelloQuest3/issues/66)  
  
 j  
  
-----------------------------------------  
  
# [Topic: What Belgium game can we play on Quest 2 and Quest 3 ?](https://api.github.com/repos/EloiStree/HelloQuest3/issues/67)  
...
# [Topic: Is F-Droid usable on Quest 3 ?](https://api.github.com/repos/EloiStree/HelloQuest3/issues/68)  
  
   
  
-----------------------------------------  
  
# [Game: Airwolf Mini Game](https://api.github.com/repos/EloiStree/HelloQuest3/issues/69)  
...
# [Game: CoasterMania - Puzzle Mode & Room Mesh](https://api.github.com/repos/EloiStree/HelloQuest3/issues/70)  
...
# [Question: How to publish an application on Oculus Lab ?](https://api.github.com/repos/EloiStree/HelloQuest3/issues/71)  
...
# [Topic: How to add WebXR app to the Quest Lab store ?](https://api.github.com/repos/EloiStree/HelloQuest3/issues/72)  
...
# [Topic: Depth API ? What it is and what is usable ?](https://api.github.com/repos/EloiStree/HelloQuest3/issues/73)  
...
# [Topic: Where to download 3D model of the Quest 3 ?](https://api.github.com/repos/EloiStree/HelloQuest3/issues/74)  
...
# [To Do: Quest 3 controller have  a nice 3D printable slot for the controller. Do a calibration tool pin.](https://api.github.com/repos/EloiStree/HelloQuest3/issues/75)  
