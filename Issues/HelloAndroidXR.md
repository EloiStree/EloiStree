...
# 60 | [To Experiment: Make a spaceship size viewer in Mixed reality.  Where you need to caliber the horizon first.](https://github.com/EloiStree/HelloAndroidXR/issues/60)  
...
# 59 | [Note: Want to make a gun game in XR ? Here is a list of the favorite one.](https://github.com/EloiStree/HelloAndroidXR/issues/59)  
  
 https://9gag.com/gag/awZpb11#comment  
  
-----------------------------------------  
  
# 58 | [Cool Game: List of cool Mixed reality games](https://github.com/EloiStree/HelloAndroidXR/issues/58)  
...
# 57 | [Topic: Git without large file (<25Mo, <50Mo)](https://github.com/EloiStree/HelloAndroidXR/issues/57)  
...
# 56 | [Topic: Android USB Driver](https://github.com/EloiStree/HelloAndroidXR/issues/56)  
...
# 55 | [Topic, How to use vibration in Quest 3 and other XR controller ? What and how to use Buffer ?](https://github.com/EloiStree/HelloAndroidXR/issues/55)  
...
# 54 | [Topic, demo: use room game with Lego using phone scan with ARkit !!!](https://github.com/EloiStree/HelloAndroidXR/issues/54)  
...
# 53 | [Topic,Note: Can we access camera image from WebXR ?](https://github.com/EloiStree/HelloAndroidXR/issues/53)  
  
 https://immersive-web.github.io/raw-camera-access/  
  
-----------------------------------------  
  
# 52 | [Topic, Hard: Is it possible to use Socker.io to transfert image from Android to Server.](https://github.com/EloiStree/HelloAndroidXR/issues/52)  
...
# 51 | [Topic: How to cut legs, body and hand to make you be in virtual reality from camera feed ?](https://github.com/EloiStree/HelloAndroidXR/issues/51)  
...
# 50 | [Topic: Varjo demo of how to use a real wheel in a virtual game from augmented reality.](https://github.com/EloiStree/HelloAndroidXR/issues/50)  
...
# 49 | [Game: Roller on ice WebXR prototype if Utopiah](https://github.com/EloiStree/HelloAndroidXR/issues/49)  
...
# 48 | [Topic: If needed of pushing data from Android with Wifi. What speed can be reach in Mo/s](https://github.com/EloiStree/HelloAndroidXR/issues/48)  
...
# 47 | [Cool Video: Learn to play guitare in VR.](https://github.com/EloiStree/HelloAndroidXR/issues/47)  
...
# 46 | [Topic: Sketch up Exploration](https://github.com/EloiStree/HelloAndroidXR/issues/46)  
...
# 45 | [Topic: How to create stereo effect on Open XR  or Q3 ?](https://github.com/EloiStree/HelloAndroidXR/issues/45)  
...
# 44 | [Topic, Rewatch: Watch Battlestar Galactica with an XR eyes?](https://github.com/EloiStree/HelloAndroidXR/issues/44)  
  
   
  
-----------------------------------------  
  
# 43 | [Topic, Rewatch: Watch of  Ghost In the Shell with an XR eyes?](https://github.com/EloiStree/HelloAndroidXR/issues/43)  
  
 d  
  
-----------------------------------------  
  
# 42 | [Topic, Search: For an interview, I have to look for 70 years in the future of XR ? So let's look around.](https://github.com/EloiStree/HelloAndroidXR/issues/42)  
...
# 41 | [Short: AR/VR demo boat](https://github.com/EloiStree/HelloAndroidXR/issues/41)  
...
# 40 | [Topic: How to use Open XR for left and right eyes in Unity3D ?](https://github.com/EloiStree/HelloAndroidXR/issues/40)  
...
# 39 | [DIY Topic: Create your own AR project without VR headset ?](https://github.com/EloiStree/HelloAndroidXR/issues/39)  
...
# 38 | [Topic: What is com.unity.template.mixed-reality](https://github.com/EloiStree/HelloAndroidXR/issues/38)  
  
 https://docs.unity3d.com/Packages/com.unity.template.mixed-reality@1.0/manual/index.html  
  
-----------------------------------------  
  
# 37 | [Topic: What can we play on Quest 3 with 3Dof as game or application in a train ?](https://github.com/EloiStree/HelloAndroidXR/issues/37)  
...
# 36 | [Topic: Use Steam API for SteamVR games](https://github.com/EloiStree/HelloAndroidXR/issues/36)  
...
# 35 | [Experiment to code: User a pattern in the Q3 and Lynx  view to caliber on real life to do some room scaling.](https://github.com/EloiStree/HelloAndroidXR/issues/35)  
...
# 34 | [Topic: Create a virtual desktop application XR in Unity3D ?](https://github.com/EloiStree/HelloAndroidXR/issues/34)  
...
# 33 | [Cool Design: Hand rotation to preview menu :)](https://github.com/EloiStree/HelloAndroidXR/issues/33)  
...
# 32 | [Topic,Unity; Is the unity MR package template is useful ?](https://github.com/EloiStree/HelloAndroidXR/issues/32)  
  
 https://docs.unity3d.com/Packages/com.unity.template.mixed-reality@1.0/manual/index.html  
  
-----------------------------------------  
  
# 31 | [Topic, Must Know: What is Web XR ?](https://github.com/EloiStree/HelloAndroidXR/issues/31)  
...
# 30 | [Question, Off topic: How to generate 3D models with AI for draft project during prototype stage of project ?](https://github.com/EloiStree/HelloAndroidXR/issues/30)  
...
# 29 | [Question: How many time can last a USB C connector before breaking ? How to save them ?](https://github.com/EloiStree/HelloAndroidXR/issues/29)  
...
# 28 | [Question: We can use multithread with Unity job system.. So how many thread can we use on Q3 and LyR](https://github.com/EloiStree/HelloAndroidXR/issues/28)  
  
   
  
-----------------------------------------  
  
# 27 | [Topic: What look like the world through screen and camera in XR (Q3 and Lynx R1) ](https://github.com/EloiStree/HelloAndroidXR/issues/27)  
  
   
  
-----------------------------------------  
  
# 26 | [Topic, Main: How can we make a game running on Lynx R1 & Quest 3 (see Pico)](https://github.com/EloiStree/HelloAndroidXR/issues/26)  
  
   
  
-----------------------------------------  
  
# 25 | [Topic: Can we record from an external microphone on Q3 and Lynx with the good Unity3D code?](https://github.com/EloiStree/HelloAndroidXR/issues/25)  
  
   
  
-----------------------------------------  
  
# 24 | [Topic: How to record and replay from microphone to test the sound ?](https://github.com/EloiStree/HelloAndroidXR/issues/24)  
  
   
  
-----------------------------------------  
  
# 23 | [Topic: How to create good realistic and fake shadow effect in AR XR headset.](https://github.com/EloiStree/HelloAndroidXR/issues/23)  
  
   
  
-----------------------------------------  
  
# 22 | [Topic, Main: How to create portal effect and cut through wall effect ?](https://github.com/EloiStree/HelloAndroidXR/issues/22)  
...
# 21 | [Topic, To code: XR Room calibration using no native code only XR ](https://github.com/EloiStree/HelloAndroidXR/issues/21)  
...
# 20 | [Cool video: Magic hands  (measure tool with hands)](https://github.com/EloiStree/HelloAndroidXR/issues/20)  
...
# 19 | [ADB, User case: Extract /some APK from an app](https://github.com/EloiStree/HelloAndroidXR/issues/19)  
...
# 18 | [Topic: How to connect a microphone on Q3/Lynx and what would be the best microphone to use in what situation ?](https://github.com/EloiStree/HelloAndroidXR/issues/18)  
  
   
  
-----------------------------------------  
  
# 17 | [Topic: How can you extract an application on Android XR with ADB and share it to others ?](https://github.com/EloiStree/HelloAndroidXR/issues/17)  
...
# 16 | [Topic: Situation Specific Application: Bed, Train, Coffee , Outside, ...](https://github.com/EloiStree/HelloAndroidXR/issues/16)  
...
# 15 | [Question: How to install keyboard layout BeFR on Android XR ?](https://github.com/EloiStree/HelloAndroidXR/issues/15)  
  
   
  
-----------------------------------------  
  
# 14 | [Keyword: Spatial Computing ](https://github.com/EloiStree/HelloAndroidXR/issues/14)  
  
 Coming from Apple : https://developer.apple.com/wwdc23/topics/spatial-computing/  
  
-----------------------------------------  
  
# 13 | [To Code: Do Reality hack on Lynx and Quest (with native texture and with overlayer)](https://github.com/EloiStree/HelloAndroidXR/issues/13)  
...
# 12 | [Topic: How to bend the 3D object your create with your mixed reality environment ?](https://github.com/EloiStree/HelloAndroidXR/issues/12)  
...
# 11 | [Topic: How to create depth effect in game without stereoscopie ?](https://github.com/EloiStree/HelloAndroidXR/issues/11)  
...
# 10 | [Important, Topic: How to use 2D Apk in the Quest and how to install Ads blocker in Quest 3 and Lynx R1 ^^.](https://github.com/EloiStree/HelloAndroidXR/issues/10)  
  
 https://www.youtube.com/shorts/-BsQq3pBHvo  
  
-----------------------------------------  
  
# 9 | [Topic, Main: How to use ALXR  on Lynx and Quest 3 ?](https://github.com/EloiStree/HelloAndroidXR/issues/9)  
  
 https://github.com/korejan/ALXR-nightly/releases  
  
-----------------------------------------  
  
# 8 | [Topic, Curiosity: Stochastic Depth Compositing of (Nova)](https://github.com/EloiStree/HelloAndroidXR/issues/8)  
...
# 7 | [Topic, Network: Be able to use synchronize pointer like Realtime board.](https://github.com/EloiStree/HelloAndroidXR/issues/7)  
...
# 6 | [Topic: What fond to use in XR/VR devices ](https://github.com/EloiStree/HelloAndroidXR/issues/6)  
  
   
  
-----------------------------------------  
  
# 5 | [Topic: Create WebXR game (without Uniyt3D) ](https://github.com/EloiStree/HelloAndroidXR/issues/5)  
  
   
  
-----------------------------------------  
  
# 4 | [Topic, Video: How does the venting of a Quest 2-3 and the Lynx is designed ?](https://github.com/EloiStree/HelloAndroidXR/issues/4)  
...
# 3 | [Video: Good example of 3D room mesh use](https://github.com/EloiStree/HelloAndroidXR/issues/3)  
...
# 2 | [Topic: Can we create our own headset if we can't buy some.](https://github.com/EloiStree/HelloAndroidXR/issues/2)  
...
# 1 | [Topic: How to try 3dof VR on phone with ALVR: https://www.youtube.com/watch?v=lr-q-4GT1lM](https://github.com/EloiStree/HelloAndroidXR/issues/1)  
