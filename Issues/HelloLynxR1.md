...
# 105 | [Topic: How to use use ALVR on Quest and on Lynx R1?](https://github.com/EloiStree/HelloLynxR1/issues/105)  
  
 https://youtu.be/PD_MobYv7-o  
  
-----------------------------------------  
  
# 104 | [Topic, Lynx MR GitHub: LynxCarDealer](https://github.com/EloiStree/HelloLynxR1/issues/104)  
  
 https://github.com/Lynx-MR/LynxCarDealer  
  
-----------------------------------------  
  
# 103 | [Topic, Lynx MR GitHub: LynxPlanetarium](https://github.com/EloiStree/HelloLynxR1/issues/103)  
  
 https://github.com/Lynx-MR/LynxPlanetarium  
  
-----------------------------------------  
  
# 102 | [Topic, Lynx MR GitHub: LynxMarble](https://github.com/EloiStree/HelloLynxR1/issues/102)  
  
 https://github.com/Lynx-MR/LynxMarble  
  
-----------------------------------------  
  
# 100 | [Topic, Lynx MR GitHub: LynxBrush](https://github.com/EloiStree/HelloLynxR1/issues/100)  
  
 [LynxBrush](https://github.com/Lynx-MR/LynxBrush)(https://github.com/Lynx-MR/LynxBrush  
  
-----------------------------------------  
  
# 99 | [Topic, Lynx MR GitHub: ALVR-OpenXR-Engine](https://github.com/EloiStree/HelloLynxR1/issues/99)  
  
 [ALVR-OpenXR-Engine](https://github.com/Lynx-MR/ALVR-OpenXR-Engine) https://github.com/Lynx-MR/ALVR-OpenXR-Engine  
  
-----------------------------------------  
  
# 98 | [Topic, Lynx MR GitHub: ALXR](https://github.com/EloiStree/HelloLynxR1/issues/98)  
  
 https://github.com/Lynx-MR/ALXR  
  
-----------------------------------------  
  
# 97 | [Topic, Lynx MR GitHub: Lynx-MR ( https://github.com/Lynx-MR )](https://github.com/EloiStree/HelloLynxR1/issues/97)  
...
# 96 | [Topic, Lynx MR GitHub: LynxAndroidSystemCom](https://github.com/EloiStree/HelloLynxR1/issues/96)  
  
 https://github.com/Lynx-MR/LynxAndroidSystemCom  
  
-----------------------------------------  
  
# 95 | [Topic: Create you own launcher on Lynx R1 ?](https://github.com/EloiStree/HelloLynxR1/issues/95)  
...
# 94 | [Support: Help someone to start with his project on Lynx.](https://github.com/EloiStree/HelloLynxR1/issues/94)  
...
# 93 | [Topic: What is the fastest way to convert Renderer Texture to file store state or Wifi pushed.](https://github.com/EloiStree/HelloLynxR1/issues/93)  
...
# 92 | [Question: Where is the Lynx store ? How to publish an app on the first version of the store ? (2023 11 20)](https://github.com/EloiStree/HelloLynxR1/issues/92)  
...
# 91 | [Question: Put and SD card with fast writing speed in Lynx could make file writing faster ? If yes, how fast can we go if we want to record.](https://github.com/EloiStree/HelloLynxR1/issues/91)  
  
   
  
-----------------------------------------  
  
# 90 | [Question: Can we play android background service app on the Lynx ?](https://github.com/EloiStree/HelloLynxR1/issues/90)  
...
# 89 | [Live: 13 Nov 2023](https://github.com/EloiStree/HelloLynxR1/issues/89)  
...
# 88 | [Video: Publish you Lynx R1 on SideQuest ? Please do :) Here is why.](https://github.com/EloiStree/HelloLynxR1/issues/88)  
...
# 87 | [Video: How to download, install and Lynx public git project  and how to extract APK on an Android device.](https://github.com/EloiStree/HelloLynxR1/issues/87)  
...
# 86 | [Code Sample:  Demo Lynx Brush](https://github.com/EloiStree/HelloLynxR1/issues/86)  
...
# 85 | [Topic,Unity3D: Import Camera capture of Lynx in the project ?](https://github.com/EloiStree/HelloLynxR1/issues/85)  
...
# 84 | [Archive: The texture ](https://github.com/EloiStree/HelloLynxR1/issues/84)  
...
# 83 | [Hard Tech Topic: Can we emulate a camera in Android device to inject image in it from Unity3D ? Aim is to extract it with SCRCPY.](https://github.com/EloiStree/HelloLynxR1/issues/83)  
...
# 82 | [Topic: How to stream camera or in game content to an other device from Lynx ?](https://github.com/EloiStree/HelloLynxR1/issues/82)  
...
# 81 | [Topic: We can use SrcCpy v2.2 to stream camera of android device !!! And so of the 4 cameras of the Lynx  (^ OoO)](https://github.com/EloiStree/HelloLynxR1/issues/81)  
...
# 80 | [Topic: Is it possible to publish on SideQuest a Lynx R1 game ? What would be the process ?](https://github.com/EloiStree/HelloLynxR1/issues/80)  
...
# 79 | [Topic: Where can I find good image of the Lynx R1 for media purpose ?](https://github.com/EloiStree/HelloLynxR1/issues/79)  
  
   
  
-----------------------------------------  
  
# 78 | [Video: What look like the sound quality of the Lynx R1 speaker ?](https://github.com/EloiStree/HelloLynxR1/issues/78)  
...
# 77 | [Topic,Question: What look like the sound generated by Lynx R1 ?](https://github.com/EloiStree/HelloLynxR1/issues/77)  
...
`adb shell am start -a android.intent.action.VIEW -d https://www.youtube.com/playlist?list=PLlKF3kVp_2FbrXBY-_9_s-zZcJMJzvJWN`
...
# 76 | [Topic,Video, Guide: What is the Lynx demo manager (and the surrounding ADB SCRCPY) ?](https://github.com/EloiStree/HelloLynxR1/issues/76)  
...
# 75 | [Topic, Game: I want to play game and try app !!! Where to go ?](https://github.com/EloiStree/HelloLynxR1/issues/75)  
...
# 74 | [Topic: Make a screenshot from ADB `adb shell screencap -p /sdcard/screencap1.png && adb pull /sdcard/screencap1.png`](https://github.com/EloiStree/HelloLynxR1/issues/74)  
  
 `adb shell screencap -p /sdcard/screencap1.png && adb pull /sdcard/screencap1.png`  
  
-----------------------------------------  
  
# 73 | [Topic, Game : What are the game that are runnable in WebXR on the Lynx R1 ?](https://github.com/EloiStree/HelloLynxR1/issues/73)  
...
# 72 | [Question: What happens if I do a Unity screen capture ? And a Unity screencapture X4 ?](https://github.com/EloiStree/HelloLynxR1/issues/72)  
...
# 71 | [Topic: With Kinect 1 & 2 I had this question of the danger of infrared light... With Lynx I must re-ask this question without good answer.](https://github.com/EloiStree/HelloLynxR1/issues/71)  
...
# 70 | [Topic, Main: Important gauge to have: FPS, Battery State, Heat of the device Battery state compare to normal use., ...](https://github.com/EloiStree/HelloLynxR1/issues/70)  
...
# 69 | [Topic, Video: Raw video about sideloading with SideQuest, Lynx Manager and web portal. (1 hour)](https://github.com/EloiStree/HelloLynxR1/issues/69)  
...
# 68 | [Question: Can we play 2D application on Lynx R1 ? ](https://github.com/EloiStree/HelloLynxR1/issues/68)  
...
# 67 | [Topic: What is F-Droid ?](https://github.com/EloiStree/HelloLynxR1/issues/67)  
...
# 66 | [Topic,Important: How to add your Lynx device serial number to the portal ? ](https://github.com/EloiStree/HelloLynxR1/issues/66)  
...
# 65 | [Forum Topic: In-App Purchases Availability](https://github.com/EloiStree/HelloLynxR1/issues/65)  
...
# 64 | [Forum Topic:  Retrieving camera frames for custom Computer Vision processing](https://github.com/EloiStree/HelloLynxR1/issues/64)  
...
# 63 | [Forum Topic: Can the Lynx-R1 support ARFoundation/ARCore currently, or is it planned?](https://github.com/EloiStree/HelloLynxR1/issues/63)  
...
# 62 | [Forum topic: List of OpenXR extensions available on Lynx runtime](https://github.com/EloiStree/HelloLynxR1/issues/62)  
...
# 61 | [Forum Topic:  Use Lynx on StereoKit ?](https://github.com/EloiStree/HelloLynxR1/issues/61)  
  
 https://portal.lynx-r.com/support/thread/stereokit  
  
-----------------------------------------  
  
# 60 | [Raw topic: What is XR_EXT_hand_interaction of Khronos ?](https://github.com/EloiStree/HelloLynxR1/issues/60)  
...
# 59 | [Forum Thread: Streamed PCVR + passthrough](https://github.com/EloiStree/HelloLynxR1/issues/59)  
...
# 58 | [Forum Thread: app DJI GO](https://github.com/EloiStree/HelloLynxR1/issues/58)  
...
# 57 | [Forum Thread: Root the devices](https://github.com/EloiStree/HelloLynxR1/issues/57)  
...
# 56 | [From Thread: WebXR support at launch?](https://github.com/EloiStree/HelloLynxR1/issues/56)  
...
# 55 | [From Thread: PC Tethering/Remoting](https://github.com/EloiStree/HelloLynxR1/issues/55)  
...
# 54 | [Question: Where to is the demo or code to have access to camera stream of the Lynx R1 ?](https://github.com/EloiStree/HelloLynxR1/issues/54)  
...
# 53 | [Topic,Cool Video: Use AR to be use as Video Blog ?](https://github.com/EloiStree/HelloLynxR1/issues/53)  
...
# 52 | [Question: Can we add microphone with USB C to Lynx R1 ? (Yes)](https://github.com/EloiStree/HelloLynxR1/issues/52)  
...
# 51 | [Question: Can you use USB C hub on Lynx ? ](https://github.com/EloiStree/HelloLynxR1/issues/51)  
...
# 50 | [Topic: Missing controller, Lynx don't have controller in it first batch. So how can we use morse to maximize button pressing. ?](https://github.com/EloiStree/HelloLynxR1/issues/50)  
  
   
  
-----------------------------------------  
  
# 49 | [Manuel: Wifi and Bluetooth Device Power and Regulation EU](https://github.com/EloiStree/HelloLynxR1/issues/49)  
...
# 48 | [FAQ: Why my Lynx don't appear when I plug it in the computer ?](https://github.com/EloiStree/HelloLynxR1/issues/48)  
...
# 47 | [Question: What is the  size of the Lynx R1 in storage ? ( 93-100 Go)](https://github.com/EloiStree/HelloLynxR1/issues/47)  
...
# 46 | [Experiment, Fun: Lynx Monocle with a range of screens from the best to the worst to see what I would look like to have the best screen ever at  200€+ in the future.](https://github.com/EloiStree/HelloLynxR1/issues/46)  
...
# 45 | [Question: what does the device sound like  ?](https://github.com/EloiStree/HelloLynxR1/issues/45)  
  
   
  
-----------------------------------------  
  
# 44 | [Question: what does look like the microphone sound of the device ?](https://github.com/EloiStree/HelloLynxR1/issues/44)  
  
   
  
-----------------------------------------  
  
# 43 | [Quesion: Does Lynx device allows to have a webcam ?](https://github.com/EloiStree/HelloLynxR1/issues/43)  
  
   
  
-----------------------------------------  
  
# 42 | [Topic, to add: 3D drunk key print for the Usb C of the Lynx ](https://github.com/EloiStree/HelloLynxR1/issues/42)  
...
# 41 | [Topic: How to unfold the SRCCPY video and image to an other format ?](https://github.com/EloiStree/HelloLynxR1/issues/41)  
...
# 40 | [Topic, Video: How to use the Lynx default manager ?](https://github.com/EloiStree/HelloLynxR1/issues/40)  
...
# 39 | [Topic, Keyword: ALXR and ALVR, how to use it and what is it ?](https://github.com/EloiStree/HelloLynxR1/issues/39)  
  
 https://github.com/korejan/ALXR-nightly/releases  
  
-----------------------------------------  
  
# 38 | [Topic: What watt and voltage do you need to reload the Lynx at it full state ?](https://github.com/EloiStree/HelloLynxR1/issues/38)  
...
# 37 | [Question: Can we use the Lynx all day long ?](https://github.com/EloiStree/HelloLynxR1/issues/37)  
...
# 36 | [To create: STL to hold a specific webcam in front of the glass for "real" eye perspective recording.](https://github.com/EloiStree/HelloLynxR1/issues/36)  
...
# 35 | [To create: STL to protect the Lens in transport that hold the magnet.](https://github.com/EloiStree/HelloLynxR1/issues/35)  
  
 Print STL that hold to the holes and magnet of the headset or can be clip to protect the lens in transport  
  
-----------------------------------------  
  
# 34 | [Experiment, to code:  What ADB command over WiFi could be usefull or mandatory to help managing it when you should demo. (Sleep mode, power of and other CMD)](https://github.com/EloiStree/HelloLynxR1/issues/34)  
...
# 33 | [Topic: It is dangerous to go doing 10% of battery and until 0% ?](https://github.com/EloiStree/HelloLynxR1/issues/33)  
  
 I don't have the answer but I will check around that later if I have the occasion to ask it.  
  
-----------------------------------------  
  
# 32 | [Topic: How many time can you use the Lynx on batteries before falling on the 10% power saving stage of the device.](https://github.com/EloiStree/HelloLynxR1/issues/32)  
...
# 31 | [Experiment, Need to code one day: Send image to a PC that compute mesh or Gauss and send the result back to the Lynx.](https://github.com/EloiStree/HelloLynxR1/issues/31)  
  
   
  
-----------------------------------------  
  
# 30 | [Topic: What library of AR world could be use to scan around the mesh of the rooms ?](https://github.com/EloiStree/HelloLynxR1/issues/30)  
  
 
![image](https://github.com/EloiStree/HelloLynxR1/assets/20149493/6df3a728-fe75-4355-baf0-38fd1a267afc)
...
# 29 | [Question: If I record a video with ScrCopy and replay it on phone with the good size. Can I watch it throw the gift len ?](https://github.com/EloiStree/HelloLynxR1/issues/29)  
...
# 28 | [Question: Can we record by putting a webcam in front of the lens ?](https://github.com/EloiStree/HelloLynxR1/issues/28)  
  
 Don't know yet. I am trying it asap.  
  
-----------------------------------------  
  
# 27 | [Question: How to stream and record the Lynx R1 with Side Quest (1600:1600:0:0 & 3200:1600:0:0)](https://github.com/EloiStree/HelloLynxR1/issues/27)  
...
# 26 | [Topic: What are the best way to charge the Lynx R1 ?](https://github.com/EloiStree/HelloLynxR1/issues/26)  
...
# 25 | [Must know: DOT NOT TRY TO OPEN THE DEVICE.](https://github.com/EloiStree/HelloLynxR1/issues/25)  
...
# 24 | [Hello world: First look at the documentation on the Portal.](https://github.com/EloiStree/HelloLynxR1/issues/24)  
...
# 23 | [Experiment to code: Try to do a controller from the Steam Deck square screen in the IR texture.](https://github.com/EloiStree/HelloLynxR1/issues/23)  
  
   
  
-----------------------------------------  
  
# 22 | [Experiment to code: Use AR foundation or Vuforia 6DOF from image instead of the lynx default system.](https://github.com/EloiStree/HelloLynxR1/issues/22)  
...
So it would maybe possible to add an image on the table or in front of you to be able to position the headset and allows it to be use in Train or place where the sensor a not usable.  
  
-----------------------------------------  
  
# 21 | [Question: How to root Lynx R1 ?](https://github.com/EloiStree/HelloLynxR1/issues/21)  
...
# 20 | [Manual: Wiki of Lynx community (miraheze)](https://github.com/EloiStree/HelloLynxR1/issues/20)  
  
 https://lynx.miraheze.org/wiki/Lynx_Community_Wiki  
  
-----------------------------------------  
  
# 19 | [Topic: what is the point cloud in Quest ?](https://github.com/EloiStree/HelloLynxR1/issues/19)  
...
# 18 | [Topic: Learn Shader Graph and shader filter in Unity by doing Lynx camera weird filters.](https://github.com/EloiStree/HelloLynxR1/issues/18)  
  
 Have fun create filter for the Lynx that change color. Or do some distortion.  
  
-----------------------------------------  
  
# 17 | [To code: Play real life with delay like the old experiments.](https://github.com/EloiStree/HelloLynxR1/issues/17)  
...
# 16 | [Topic, WARNING: Several time today I put my quest on rest and almost burn it.](https://github.com/EloiStree/HelloLynxR1/issues/16)  
...
# 15 | [Topic, Note: The microphone is bad... But the noise cancelation is crazy !!!](https://github.com/EloiStree/HelloLynxR1/issues/15)  
...
# 14 | [Topic: what are the exact resolution of the 6 cameras  of the Lynx? ](https://github.com/EloiStree/HelloLynxR1/issues/14)  
...
# 13 | [Topic: Use hand Occlusion when gripping objects](https://github.com/EloiStree/HelloLynxR1/issues/13)  
...
# 12 | [Interesting question: How did Lynx do the 6DOF and it is by library use or coded from scratch.](https://github.com/EloiStree/HelloLynxR1/issues/12)  
...
# 11 | [Topic, Tutorial: How to update the Lynx R1](https://github.com/EloiStree/HelloLynxR1/issues/11)  
  
 Official documentation: https://portal.lynx-r.com/documentation/view/updating-your-device  
  
-----------------------------------------  
  
# 10 | [Tutorial, video: First step in Lynx R1 project  (First one I saw on the web)](https://github.com/EloiStree/HelloLynxR1/issues/10)  
...
# 9 | [Code: Utraleap hand interaction Github toolbox](https://github.com/EloiStree/HelloLynxR1/issues/9)  
...
# 8 | [Topic: what texture can we access and what are their ?](https://github.com/EloiStree/HelloLynxR1/issues/8)  
...
# 7 | [Topic: What can we use or see in the Dark with the Lynx R1 without adding IR light. (6 cameras)](https://github.com/EloiStree/HelloLynxR1/issues/7)  
...
# 6 | [Topic, R&D : Can we use camera to generate image for 3D generation like 3D Gaussian on PC](https://github.com/EloiStree/HelloLynxR1/issues/6)  
...
# 5 | [Topic: Use Quest Pro and Quest 3 controller usable on Lynx to have controller.](https://github.com/EloiStree/HelloLynxR1/issues/5)  
...
# 4 | [Request Tutorial: Have access an use the camera of the Lynx](https://github.com/EloiStree/HelloLynxR1/issues/4)  
...
# 3 | [Question: Eloi: Does the Lynx API will have in the start a tool to recognize the volume of the room: wall,  table, ground, etc ?](https://github.com/EloiStree/HelloLynxR1/issues/3)  
...
# 2 | [Question: thrman:is the hand tracking wil be able to work in th middle up  or it's tied to be under ?](https://github.com/EloiStree/HelloLynxR1/issues/2)  
...
# 1 | [Topic: Oculus Quest AR Passthrough](https://github.com/EloiStree/HelloLynxR1/issues/1)  
